...
stats_path = "stats_replay"
model_path = "model/Epoch480ModelData.tm"
...
def rl_training(base_model, reference_replay):
    ...
    generator = TrajectoryGenerator(model, frozen_model, reference_replay, num_envs=8, max_batch=4)
...
if __name__ == "__main__":
    ...
    rl_training(model_path, stats_path)