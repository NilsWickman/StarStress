...
class ReplayState():
    ...
    def stats(self):
        print(
            f"Stats:   steps: {self.steps}, batches: {self.stored_count}, valid: {self.ops}"
        )
